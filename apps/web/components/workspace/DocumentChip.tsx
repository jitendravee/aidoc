...
export default function DocumentChip({ doc, onView, onUndo, isUndoing }: DocumentChipProps) {
  return (
    <div className="mt-2 flex items-center justify-between gap-2 rounded-md border border-border bg-surface px-2.5 py-2">
      ...
      <div className="flex shrink-0 items-center gap-1">
        <Button size="sm" variant="ghost" className="h-7 px-2 text-xs" onClick={() => onView(doc.document_id)}>
          View
        </Button>
        {doc.can_undo && (
          <Button
